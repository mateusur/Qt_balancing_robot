...
public slots:
    ...
    * \param[in] minValue - minimalna wartość.
    * \param[in] maxValue - maksymalna wartość.
    */
    ...
    * \param[in] value - aktualna wartość.
    */
    ...
    * \param[in] alarmValue - alarmująca wartość.
    */
    ...
    * \param[in] borderRadius - wartość promienia ramki.
    */
    ...
    * \param[in] bgRadius - wartość promienia tła.
    */
    ...
    * \param[in] headRadius - wartość promienia główki baterii.
    */
    ...
    * \param[in] borderColorStart - kolor początkowy ramki.
    */
    ...
    * \param[in] borderColorEnd - kolor końcowy ramki.
    */
    ...
    * \param[in] alarmColorStart - kolor początkowy alarmu.
    */
    ...
    * \param[in] alarmColorEnd - kolor końcowy alarmu.
    */
    ...
    * \param[in] normalColorStart - kolor początkowy wypełnienia.
    */
    ...
    * \param[in] normalColorEnd - kolor końcowy wypełnienia.
    */
...
signals:
    ...
    * \param[in] value - aktualna wartość naładowania.
    */
